    ...
    public class EcoCBRDB
    {
        ...
        public DataTable selectMMPConditional(List<Tuple<string, string>> listCriteria)
        {
            ...
            try
            {
                ...
                SqlCommand cm = new SqlCommand();
                //commandText = "SELECT * FROM data_edited ";
                commandText = "SELECT  [Case No],[Material Type],[Process],[Product Weight(gram)] FROM data_edited ";
        ...
        public DataTable selectTransportConditional(List<Tuple<string, string>> listCriteria)
        {
            ...
            try
            {
                ...
                SqlCommand cm = new SqlCommand();
                //commandText = "SELECT * FROM data_edited ";
                commandText = "SELECT  [Case No],[Origin],[Destination],[Transport Type],[Distance(km)],[Product Weight(gram)] FROM data_edited ";
        ...
        public DataTable selectEOLConditional(List<Tuple<string, string>> listCriteria)
        {
            ...
            try
            {
                ...
                SqlCommand cm = new SqlCommand();
                //commandText = "SELECT * FROM data_edited ";
                commandText = "SELECT  [Case No],[Recycled(%)],[Incinerated (%)],[Landfill (%)],[Product Weight(gram)] FROM data_edited ";
        ...
        public DataTable selectProductDesignConditional(List<Tuple<string, string>> listCriteria)
        {
            ...
            try
            {
                ...
                SqlCommand cm = new SqlCommand();
                //commandText = "SELECT * FROM data_edited ";
                commandText = "SELECT  [Case No],[Thin Region(mm)],[Thick Region(mm)],[Height(mm)],[Surface Area(mm2)],[Volume(mm3)],[Perimeter(mm)],[Product Weight(gram)] FROM data_edited ";
